...
app.get('/rediger/slideshows/:slideshowId', (req, res) => {
  ...
  db.collection(`slideshows`).doc(slideshowId).doc('slides').listCollections().then((collection) => {
    //if (collection.exists){
      collection.forEach((collection) =>{
        console.log(collection.id);
      })

      res.render(__dirname+'/public/views/MasterSlide.ejs', {slideshow: collection})
   // }else{
