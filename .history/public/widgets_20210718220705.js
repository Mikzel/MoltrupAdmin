...
function vejr(data){
    switch (data.vistype) {
        case 'vejrpt':
            ...
            <div class="vejrpt vejr" id="${data.id}" style= "grid-area: ${data.start};grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};">
            <a class="weatherwidget-io" href="https://forecast7.com/da/56d208d77/vildbjerg/" data-mode="Current" data-theme="original" data-basecolor="rgba(31, 86, 124, 0)" data-textcolor="${data.farve || '#ffffff'}" data-cloudcolor="${data.farve || '#ffffff'}">Vildbjerg, Denmark</a>
            </div>`);
            break;
        ...
        case 'vejrudsigt':
            ...
            <!-- weather widget start --><div class="vejrudsigt vejr"  id="${data.id}" style= "grid-area: ${data.start};grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};" id="m-booked-prime-days-55395"> <div class="weather-customize widget-type-prime-days">  <div class="booked-prime-days-in"> <div class="booked-prime-days-data"> <div class="booked-pd-today"> <div class="booked-pd-today-img wrz-03 "></div> <div class="booked-pd-today-temperature"> <div class="booked-wzs-pd-val"> <div class="booked-wzs-pd-number"><span class="plus">+</span>18</div> <div class="booked-wzs-pd-dergee"> <div class="booked-wzs-pd-dergee-val">&deg;</div> <div class="booked-wzs-pd-dergee-name">C</div> </div> </div> </div> <div class="booked-pd-today-extreme"> <div class="booked-pd booked-pd-h"><span>High:</span><span class="plus">+</span>18</div> <div class="booked-pd booked-pd-l"><span>Low:</span><span class="plus">+</span>14</div> </div> </div> <div class="booked-pd-ndays">  <div class="booked-pd-nitem"> <div class="booked-pd-nidi wrz-sml wrzs-03"></div> <div class="booked-pd-nidw">Man</div> </div>  <div class="booked-pd-nitem"> <div class="booked-pd-nidi wrz-sml wrzs-03"></div> <div class="booked-pd-nidw">Tir</div> </div>  <div class="booked-pd-nitem"> <div class="booked-pd-nidi wrz-sml wrzs-01"></div> <div class="booked-pd-nidw">Ons</div> </div>  <div class="booked-pd-nitem"> <div class="booked-pd-nidi wrz-sml wrzs-03"></div> <div class="booked-pd-nidw">Tor</div> </div>  <div class="booked-pd-nitem"> <div class="booked-pd-nidi wrz-sml wrzs-03"></div> <div class="booked-pd-nidw">Fre</div> </div>  <div class="booked-pd-nitem"> <div class="booked-pd-nidi wrz-sml wrzs-01"></div> <div class="booked-pd-nidw">Lør</div> </div> </div> </div> </div> </div> </div><script type="text/javascript"> var css_file=document.createElement("link"); var widgetUrl = location.href; css_file.setAttribute("rel","stylesheet"); css_file.setAttribute("type","text/css"); css_file.setAttribute("href",'https://s.bookcdn.com/css/w/booked-wzs-widget-prime-days.css?v=0.0.1'); document.getElementsByTagName("head")[0].appendChild(css_file); function setWidgetData_55395(data) { if(typeof(data) != 'undefined' && data.results.length > 0) { for(var i = 0; i < data.results.length; ++i) { var objMainBlock = document.getElementById('m-booked-prime-days-55395'); if(objMainBlock !== null) { var copyBlock = document.getElementById('m-bookew-weather-copy-'+data.results[i].widget_type); objMainBlock.innerHTML = data.results[i].html_code; if(copyBlock !== null) objMainBlock.appendChild(copyBlock); } } } else { alert('data=undefined||data.results is empty'); } } var widgetSrc = "https://widgets.booked.net/weather/info?action=get_weather_info;ver=7;cityID=34152;type=6;scode=124;ltid=3457;domid=w209;anc_id=41262;countday=6;cmetric=1;wlangID=1;color=137AE9;wwidth=250;header_color=ffffff;text_color=333333;link_color=08488D;border_form=1;footer_color=ffffff;footer_text_color=333333;transparent=0;v=0.0.1";widgetSrc += ';ref=' + widgetUrl;widgetSrc += ';rand_id=55395';var weatherBookedScript = document.createElement("script"); weatherBookedScript.setAttribute("type", "text/javascript"); weatherBookedScript.src = widgetSrc; document.body.appendChild(weatherBookedScript) </script><!-- weather widget end -->
            `);
       break;
...
<p style="color: ${data.farve || 'white'} !important; font-size: ${data.størrelse+'px' || '1.2rem'}; font-weight: 'bold';" class='nedtæloverskrift'>${data.tekst || ''}</p>
...
function dagensvagt(data) {
    ...
    console.log(stillinger);
console.log(imorgen);
        $(`${data.parent || 'main'}`).append(`  
    <div class="dagens-vagter"  id="${data.id}"  style="padding: 5px; font-size: ${data.størrelse+'px'??'1.4em'}; color: ${data.farve || 'white'} !important; grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end:${data.slutx};"></div>`)
...
if (stillinger.includes(posStr)) {
    ...
    fetch(`https://openapi.planday.com/hr/v1/employees/${element.employeeId}`, {
      headers: { 'X-ClientId':'03f10bae-0029-4d34-9233-de8173b32652', 
      'Authorization':`Bearer ${accessToken}`},
      method: 'get',
  })
  ...
  .then(json => {
        ...
        <p style=" color: ${data.farve || 'white'}; border-bottom: solid 2px ${data.farve || 'white'}">${beskrivelse}</p>
    </div>  `);
