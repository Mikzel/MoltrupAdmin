...
function vejr(data){
    switch (data.vistype) {
        case 'vejrpt':
            ...
            <div class="vejrpt vejr widget" id="${data.id}" style= "grid-area: ${data.start};grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};">
        ...
        case 'vejrudsigt':
            $(`${data.parent || 'main'}`).append(`
            <div class="vejrudsigt vejr widget" id="${data.id}" style= "grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};">
