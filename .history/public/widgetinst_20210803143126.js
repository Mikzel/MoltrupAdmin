...
loadPositionsListe();
    ...
    case 'slideshow':
        ...
        $('#instGrid').append(wigdetInstLayout({instCon:`
        <h3>Vælg eksisterende, eller opret nyt slideshow</h3>
        <div class="samling" id="vælgOpretSlide"> 
            <select id="slideshowsVælg">
            <option disabled selected>Vælg et eksisterende slideshow</option>
            </select>
            <input id="NytSlideshowKnap" class="knap" onclick="nytSlideshow()" value="Opret nyt slideshow" type="button"/>
            </div>
        `}));
