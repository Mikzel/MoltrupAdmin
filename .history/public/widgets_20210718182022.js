...
function vejr(data){
    switch (data.vistype) {
        case 'vejrpt':
            ...
            <a class="weatherwidget-io" href="https://forecast7.com/da/56d208d77/vildbjerg/" data-mode="Current" data-theme="original" data-basecolor="${data.farve || 'rgba(31, 86, 124, 0)'}" data-textcolor="${data.farve || '#ffffff'}" data-cloudcolor="${data.farve || '#ffffff'}">Vildbjerg, Denmark</a>
            </div>`);
            importervejrsrc();
            break;
        ...
        case 'vejrudsigt':
            ...
            <a class="weatherwidget-io" href="https://forecast7.com/da/56d208d77/vildbjerg/" data-label_1="VILDBJERG" data-theme="original" data-basecolor="${data.farve || 'rgba(31, 86, 124, 0)'}" data-textcolor="${data.farve || '#ffffff'}" data-cloudcolor="${data.farve || '#ffffff'}" >VILDBJERG</a>
        </div>
            `);
            importervejrsrc();
            break;
