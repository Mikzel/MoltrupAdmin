    ...
    case 'vejr':
        ...
        <div class="samling" id="vejrVisning">
            <div id="vejrVisType">
                ...
                <input id="PT" type="radio" name="vejrVisType">

                <label for="ugeOversigt">Uge oversigt</label>
                <input id="ugeOversigt" type="radio" name="vejrVisType">
            </div>
...
if (widget=='vejr') {
    ...
    instObj['vistype']=$('#nyhedskategorier input[type="radio"]:checked').attr('data-path');
