...
function vejr(data){
    switch (data.vistype) {
        case 'vejrpt':
            ...
            <a class="${data.aId || 'weatherwidget-io'}" href="https://forecast7.com/da/56d208d77/vildbjerg/" data-mode="Current" data-theme="original" data-basecolor="rgba(31, 86, 124, 0)" data-textcolor="${data.farve || '#ffffff'}" data-cloudcolor="${data.farve || '#ffffff'}">Vildbjerg, Denmark</a>
            </div>`);
            break;
        ...
        case 'vejrudsigt':
            ...
            <a class="${data.aId || 'weatherwidget-io'}" href="https://forecast7.com/da/56d208d77/vildbjerg/" data-label_1="VILDBJERG" data-theme="original" data-basecolor="rgba(31, 86, 124, 0)" data-textcolor="${data.farve || '#ffffff'}" data-cloudcolor="${data.farve || '#ffffff'}" >VILDBJERG</a>
        </div>
            `);
       break;
