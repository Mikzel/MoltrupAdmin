...
function tekstboks(data) {
    $('main').append(`
    <div class="tekstboks widget"  style="color: ${data.farve || 'white'}; font-size: ${data.størrelse || '2em'}; grid-area: ${data.start}; text-align:${data.align || 'left'}; grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};">
