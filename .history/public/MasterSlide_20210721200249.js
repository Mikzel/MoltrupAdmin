...
const slideinsref = ()=>{ firestore.collection(`slideshows`).doc(`${slideshowId}`).get().then((x)=>{return (x.data().SlideIns).toString()});}//firestore.collection(`slideshows`).doc(`${slideshowId}`)
