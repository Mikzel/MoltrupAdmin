...
function slideshow(data) {
    $(data.parent || 'main').append(`
        <div class="slideshow"  id="${data.id}" data-slideshowParent=${data.slideshowParent} style="grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end:${data.slutx};"></div>
    `)
}
