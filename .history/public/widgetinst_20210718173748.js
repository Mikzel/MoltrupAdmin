...
$('#instGrid').append(wigdetInstLayout({instCon: `<object data="SRC/widgetInst/${params.get('widget')}"> Din browser virker ikke med moltrupAdmin. Prøv evt. at opdatere, eller skifte browser.`}))
