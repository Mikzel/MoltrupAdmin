...
$('#instGrid').append(wigdetInstLayout({instCon: `<object data="../../${params.get('widget').replaceAll('æ','ae')}"> Din browser virker ikke med moltrupAdmin. Prøv evt. at opdatere, eller skifte browser.`, center: true}))
