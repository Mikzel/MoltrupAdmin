...
loadPositionsListe();
    ...
    case 'tekstboks':
        ...
        $('#instGrid').append(wigdetInstLayout({instCon:`
            <div class="samling">
                <h3>Tekst</h3>
                <input class="inst" type="text" placeholder="Overskrift">
                <textarea class="inst"  cols="80" rows="80"placeholder="Tekst"></textarea>
            </div>

            <div class="samling">
                <h3>Visning</h3>
                <input class="inst" data-frivillig=true type="text" placeholder="Skriftstørrelse">
                <div class="samling" id="alignValg">
                    <label for="alignVenstre">Venstre</label>
                    <input type="radio" selected id="alignVenstre" data-align="left" name="alignValg">
