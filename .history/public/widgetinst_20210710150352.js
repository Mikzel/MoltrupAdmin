    ...
    case 'dagens-vagter':
        ...
        fetch(`https://id.planday.com/connect/token`, {
          ...
          .then(json => {
                ...
                .then(res => res.json())
                .then(json => {json.data.forEach((pos)=>{console.log(pos.name);})});
...
if(videresend){return instObj;}else{throw new Error('et eller flere oblikatoriske felter står tomme!ª')}
