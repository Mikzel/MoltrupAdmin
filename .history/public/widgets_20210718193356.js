...
function vejr(data){
    switch (data.vistype) {
        case 'vejrpt':
            ...
            !function(d,s,id){ console.log(d,s,id); var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
            break;

        case 'vejrudsigt':
            $(`${data.parent || 'main'}`).append(`
            <div class="vejrudsigt vejr" id="${data.id}" style= "grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};">
            <a class="weatherwidget-io" href="https://forecast7.com/da/56d208d77/vildbjerg/" data-label_1="VILDBJERG" data-theme="original" data-basecolor="rgba(31, 86, 124, 0)" data-textcolor="${data.farve || '#ffffff'}" data-cloudcolor="${data.farve || '#ffffff'}" >VILDBJERG</a>
        </div>
            `);
            !function(d,s,id){ console.log(d,s,id); var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
            break;
