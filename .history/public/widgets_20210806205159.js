...
<div class="nedtælling widget" id='${data.id}' style="color: ${data.farve || 'white'} !important; font-size: ${data.størrelse || '2em'}; grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx}; grid-column-end: ${data.sluty}; grid-row-end:${data.slutx};">
<p style="color: ${data.farve || 'white'} !important; font-size: ${data.størrelse || '1.2rem'}; font-weight: 'bold';" class='nedtæloverskrift'>${data.tekst || ''}</p>
<p style="color: ${data.farve || 'white'} !important; font-size: ${data.størrelse|| '1rem'};"  class='nedtælud'></p>
</div>`);
...
<p class="nyhed-kategori" style="font-size: ${data.størrelse|| '1.4em'}; color: ${data.farve || 'white'}">${feed.meta.title}</p>
<ul>
...
`);
      ...
      for(i = 0; i < data.antal; i++){
        $(`#${data.id} *`).css({color: data.farve})
          ...
          <p id="autoStr" class="nyhed-overskrift" style="font-size: ${data.størrelse || '1em'}; color: ${data.farve}">${entry[i].title}</p>
          <p id="autoStr" class="nyhed-beskrivelse" style="font-size: ${data.størrelse || '1em'}; color: ${data.farve}">${entry[i].description}</p>
      </li>
          `);
...
console.log(imorgen);
        $(`${data.parent || 'main'}`).append(`  
    <div class="dagens-vagter widget"  id="${data.id}"  style="padding: 5px; font-size: ${data.størrelse??'1.4em'}; color: ${data.farve || 'white'} !important; grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end:${data.slutx};"></div>`)
