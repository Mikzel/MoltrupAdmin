...
$('#instGrid').append(wigdetInstLayout({instCon: `<object data="../../SRC/widgetInst/${params.get('widget').replaceAll('æ','ae')}"> Din browser virker ikke med moltrupAdmin. Prøv evt. at opdatere, eller skifte browser.`, center: true}))
