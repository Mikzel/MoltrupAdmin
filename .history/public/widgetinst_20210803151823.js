...
loadPositionsListe();
    ...
    case 'slideshow':
        ...
        <p>Øsnker du at redigere i et slideshow, bedes du gå </p><a href="${location.origin}/#opretny">til slideshow menuen ved forsiden</a>
        `}));
...
if(widget=='slideshow'){
    instObj['slideshowParent'] = $('#slideshowsVælg').find(':selected').val();
}
