...
function vejr(data){
    switch (data.vistype) {
        ...
        case 'vejrudsigt':
            $(`${data.parent || 'main'}`).append(`
            <div class="vejrudsigt vejr" id="${data.id}" style= "grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};">
...
function slideshow(data) {
    ...
    $(data.parent || 'main').append(`
        <div class="slideshow"  id="${data.id}" data-slideshowParent=${data.slideshowParent} style="grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end:${data.slutx};">
