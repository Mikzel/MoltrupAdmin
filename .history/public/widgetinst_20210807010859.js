...
async function genMiniSkab() {
   ...
   $('.miniSkabParent').append(`<input id="nulstilMiniSkab" onclick="$('.ubrugtCheck').attr('checked', false)" type="button" value="Nulstil placering">`)
   ...
   if ($('.ubrugtCheck:checked').length > 1) {
        if ($(e.target).prop("checked")) {
            ...
            $('.ubrugtCheck').attr("checked",false);
