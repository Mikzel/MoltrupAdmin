...
var feedurl = 'https://www.dr.dk/nyheder/service/feeds/'+data.kategori;
    ...
    .then(feed => {
      ...
      for(i = 0; i < data.antal; i++){
          ...
          <p id="autoStr" class="nyhed-overskrift" style="font-size: ${data.overskriftStørrelse || '1.4em'}; color: ${data.farve || 'white'};">${entry[i].title}</p>
          <p id="autoStr" class="nyhed-beskrivelse" style="font-size: ${data.beskrivelseStørrelse || '1em'}; color: ${data.farve || 'white'}">${entry[i].description}</p>
      </li>
          `);
