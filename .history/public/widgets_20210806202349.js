...
function tekstboks(data) {
    $('main').append(`
    <div class="tekstboks widget"  style="color: ${data.farve || 'white'};  grid-area: ${data.start}; text-align:${data.align || 'left'}; grid-column-end: ${data.sluty}; grid-row-end: ${data.slutx};">
    <h1>${data.overskrift}</h1>
    <p style="font-size: ${data.størrelse+'px' || '2em'};">${data.tekst}</p>
</div>
    `);
}
