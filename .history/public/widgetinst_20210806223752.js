...
async function genMiniSkab() {
   ...
   $('.ubrugtCheck').change((el)=>{
    if($('.ubrugtCheck:checked').length>1){
       console.log($('.ubrugtCheck:checked').index($(el)));
        console.log($('.ubrugtCheck:checked'));
        console.log($(el));
       // console.log($('.ubrugtCheck:checked').splice($('.ubrugtCheck:checked').index($(el)), 1));;
    }
});
