...
console.log(imorgen);
        $(`${data.parent || 'main'}`).append(`  
    <div class="dagens-vagter widget"  id="${data.id}"  style="padding: 5px; font-size: ${data.størrelse+'px'??'1.4em'}; color: ${data.farve || 'white'} !important; grid-area: ${data.start}; grid-column-end: ${data.sluty}; grid-row-end:${data.slutx};"></div>`)
